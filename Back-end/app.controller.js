...
// bootstrap
app.use(express.json()); // أول حاجة

// 2. الـ CORS لازم يكون هنا بالظبط قبل أي router وقبل الهيلمت
app.use(cors(corsOption())); 

// 3. تعديل الهيلمت عشان ميمنعش الـ Resource sharing
app.use(helmet({
    crossOriginResourcePolicy: { policy: "cross-origin" },
    crossOriginOpenerPolicy: { policy: "unsafe-none" }
}));

// باقي الكود (Routers والـ Static)
